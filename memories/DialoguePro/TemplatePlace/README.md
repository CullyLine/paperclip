# Thornwood Village — DialoguePro Template Place

A ready-to-play demo that showcases every feature of DialoguePro through 7 NPCs in a small fantasy village.

## Quick Setup (3 minutes)

### Step 1: Insert the DialoguePro Model

1. Open **Roblox Studio** and create a new **Baseplate** place
2. Delete the default Baseplate part from Workspace
3. Insert the **DialoguePro** model into **ReplicatedStorage**:
   - **Option A:** Open the Toolbox (View → Toolbox), search "DialoguePro", click to insert
   - **Option B:** Drag `DialoguePro.rbxmx` into ReplicatedStorage
...
1. Open `ReplicatedStorage > DialoguePro > Demo > TestDemoLevelHere`
...
1. Drag `TestDemoExampleDialog` from `ReplicatedStorage > DialoguePro > Demo` into **StarterPlayer → StarterPlayerScripts**
2. Enable the script (uncheck Disabled in Properties)
