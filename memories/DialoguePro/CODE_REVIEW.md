# DialoguePro Code Review — V1.0 Pre-Release

Comprehensive code review of the DialoguePro for Roblox, organized by severity.
...
**Files:** `DOCS.md` (lines 1300–1311), `DialoguePro.lua` (209–211)
...
### 6. **DialoguePro singleton behavior and Destroy**

**File:** `DialoguePro.lua` (lines 12–29, 217–226)
...
### 11. **DialoguePro._displayNode — choice index handling**

**File:** `DialoguePro.lua` (line 148)
