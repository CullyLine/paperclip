...
-- Visual node-graph editor for the DialoguePro system.
--
...
------------------------------------------------------------------------
local Theme          = require(script.DesignerTheme)
local AppState       = require(script.AppState)
local Canvas         = require(script.Canvas)
local PropertyPanel  = require(script.PropertyPanel)
local Toolbar        = require(script.Toolbar)

------------------------------------------------------------------------
-- Plugin toolbar button
------------------------------------------------------------------------
local toolbar = plugin:CreateToolbar("Dialogue Designer")
...
widget.Title = "Dialogue Designer — BUILD_TIMESTAMP"
