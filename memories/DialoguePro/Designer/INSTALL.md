...
A visual node-graph editor for the DialoguePro system, built as a Roblox Studio plugin.
...
7. Save the plugin — it will appear in the **Plugins** tab as "Dialogue Designer"
...
- **Save**: Creates a ModuleScript in `ReplicatedStorage.DialoguePro.Trees`
...
- The DialoguePro module in ReplicatedStorage (for the Save feature)
